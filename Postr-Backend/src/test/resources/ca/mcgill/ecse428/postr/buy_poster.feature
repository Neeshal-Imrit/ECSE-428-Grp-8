...
| smith@ap.com        | password2     | VeryCoolPoster   |
  ...
  Given the following posters exist in the system
    | title              | description                          | price | imageData                                                                                               | numberOfPurchases |
    | CoolPoster         | It's a cool poster!                  | 1.00  | iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAYAAABytg0kAAAAFElEQVR42mP8/5+hP6MggIMAAP9cAv52kBLqAAAAAElFTkSuQmCC    | 0 |
    | VeryCoolPoster     | It's a very cool poster!             | 1.55  | iVBORw0KGgoAAAANSUhEUgAAAAIAAAACCAYAAABytg0kAAAAFElEQVR42mP8/5+hP6MggIMAAP9cAv52kBLqAAAAAElFTkSuQmCC    | 0 |
